...
function openSidebar () {
    ...
    document.getElementById("sidebar__content").style.display = 'block';
    document.getElementById("sidebar__content").style.minHeight = '95vh';
...
function closeSidebar () {
    ...
    document.getElementById("sidebar__content").style.minHeight = '0';
